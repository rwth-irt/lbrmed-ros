...
// DO NOT USE WITH FZI CARTESIAN CONTROLLERS - STRONG JITTER!
public class FRIServerImpedance extends RoboticsAPIApplication {
  // members
  @Inject
  private LBR lbr_;
  ...
  private JointImpedanceControlMode control_mode_;
  ...
  public void initialize() {
    ...
    // Initialize impedance control with high stiffness for motion overlay
    control_mode_ = new JointImpedanceControlMode(5000, 5000, 2000, 2000, 1000, 1000, 500);
  ...
  public static void main(final String[] args) {
    FRIServerImpedance app = new FRIServerImpedance();
    app.runApplication();
  }
}
